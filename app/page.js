          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                We offer a wide range of vehicles to choose from, from sports
                cars to SUVs.
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                WITH TEST DRIVE YOU CAN GET THE PERFECT CAR FOR YOUR NEEDS
              </p>
            </div>
            <div className='text-center'>
              <div className='bg-blue-100 text-blue-700 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4'>
              ...
              <p className='text-gray-600'>
                DUE DILIGENCE VERIFICATION OF THE VEHICLES
              </p>
            </div>
          </div>
        </div>
      ...
      <section className='py-16 dotted-background text-white'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-blue-100 mb-8 max-w-2xl mx-auto'>
            We offer a wide range of vehicles to choose from, from sports cars
            to SUVs.
          </p>
