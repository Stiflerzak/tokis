            ...
            <div className="space-y-3">
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <span className="text-gray-700 dark:text-gray-300">KES</span>
                </div>
                <input
                  type="number"
                  value={loanAmount}
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                  KES {formatNumber(results.downPayment)}
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                  KES {formatNumber(results.loanPrincipal)}
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                  KES {formatNumber(results.totalInterest)}
                  </div>
                </div>
