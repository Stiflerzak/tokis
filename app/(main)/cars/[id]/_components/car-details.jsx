    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${car.year} ${car.make} ${car.model} on Automax!`,
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
              ...
              <Card className="pt-5">
                <CardContent>
                  <div className="flex items-center gap-2 text-lg font-medium mb-2">
                    ...
                    <h3>Automax car financing Calculator</h3>
                  </div>
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    *Based on KES 0 down payment and 4.5% interest rate
                  </div>
                </CardContent>
              </Card>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Automax Car Loan Calculator</DialogTitle>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">Automax Motors</h4>
                <p className="text-gray-600">
                  {testDriveInfo.dealership?.address || "Not Available"}
                </p>
                <p className="text-gray-600 mt-1">
                  Phone: {testDriveInfo.dealership?.phone || "+254 798616730 or +254 792538887"}
                </p>
                <p className="text-gray-600">
                  Email: {testDriveInfo.dealership?.email || "hilarymwendia97@gmail.com"}
                </p>
              </div>
            </div>
                  ...
                  ? testDriveInfo.dealership.workingHours
                      ...
                      .map((day) => (
                        ...
                        >
                          ...
                          <span>
                            {day.isOpen
                              ? `KES{day.openTime} - ${day.closeTime}`
                              : "Closed"}
                          </span>
                        </div>
                      ))
