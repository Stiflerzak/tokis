...
DROP COLUMN "state",
DROP COLUMN "website",
ALTER COLUMN "name" SET DEFAULT 'Automax Motors',
ALTER COLUMN "address" SET DEFAULT 'Kilimani, next to shell petrol',
ALTER COLUMN "phone" SET DEFAULT '+254 798616730',
